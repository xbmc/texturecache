...
# SPDX-FileCopyrightText: 2013-2020 Neil MacLeod (texturecache@nmacleod.com)
# SPDX-FileCopyrightText: 2025 Team Kodi (http://kodi.tv)
...
#
# Usage: Run script without parameters to see built-in help, or refer to the
